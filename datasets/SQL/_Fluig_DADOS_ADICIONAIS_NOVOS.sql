...
/****** Object:  View [dbo].[_Fluig_DADOS_ADICIONAIS_NOVOS]    Script Date: 31/05/2021 16:17:22 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[_Fluig_DADOS_ADICIONAIS_NOVOS] AS
...
SELECT 
	...
	WHERE	PFUNC.CODSITUACAO NOT IN ('D','I')
	/* HOMOLOGAÇÃO Dataset - fdwt_campos_adicionais_usuario */
	--AND		GUSUARIO.CODUSUARIO NOT IN (SELECT login COLLATE Latin1_General_CI_AS FROM [RIOSRV010\DSEN].[Fluig_homolog].[dbo].[ML001041])
	/* PRODUÇÃO Dataset - fdwt_campos_adicionais_usuario */ 
